...
String getPreffvalues()
{

  // readings["channel"] = (String)channelName;
  // readings["uid"] = (String)user_id;
  // readings["sec"] = (String)user_secret;

  // String jsonString = JSON.stringify(readings);
  // Serial.println(jsonString);
  String jsonString = "{\"channel\":\""+channelName+"\",\"uid\":\""+user_id+"\",\"sec\":\""+user_secret+"\"}";
  Serial.println(jsonString);
  return jsonString;
}
