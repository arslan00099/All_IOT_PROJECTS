...
#define API_KEY "AIzaSyDgBYrDX0ZoOYJFH9HXXiDo72g0i0qxA1U"

// Insert Authorized Email and Corresponding Password
#define USER_EMAIL "test@gmail.com"
#define USER_PASSWORD "#test00998"

// Insert Firebase storage bucket ID e.g bucket-name.appspot.com
#define STORAGE_BUCKET_ID "myzeleyes.appspot.com"
// For example:
...
void capturePhotoSaveLittleFS( void ) {
  ...
  // Photo file name
char filename[30];
  sprintf(filename, "/photo_%lu.jpg", millis()); // Unique filename based on current timestamp
