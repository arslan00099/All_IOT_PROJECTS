...
#define API_KEY "AIzaSyCIVDZHxcAqIhlFF7GpgI9VJNIlswUAh_Q"

/* 3. Define the RTDB URL */
#define DATABASE_URL "https://curtainproject-77861-default-rtdb.firebaseio.com/" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
...
String parentPath = "/curtain";
int data[7];
String childPath[7] = {"/step", "/max","/slider","/ucvalue","/dcvalue","/uvalue","/dvalue"};
...
void streamCallback(MultiPathStream stream)
{
  ...
  for (size_t i = 0; i < numChild; i++)
  {
    ...
    {const char *myString = stream.value.c_str();
      data[i]=atoi(myString);
