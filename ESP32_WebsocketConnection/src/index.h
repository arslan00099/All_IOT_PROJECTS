...
<script>
 ...
 const socket = new WebSocket("ws://" + window.location.hostname + ":81/");
    ...
    socket.onmessage = function (event) {
        ...
        document.getElementById("one").value = data.total;
        document.getElementById("two").value = data.up;
        document.getElementById("three").value = data.left;
        document.getElementById("four").value = data.right;
        document.getElementById("five").value = data.down;
    };
