...
const char* ssid = "realmefz";
const char* password = "111222333099";

//external web server address
const char* server = "http://www.spreadstyle.cyou/Api/ESP32/Location/Update";
...
void loop(void) {
  ...
  gpsData = "{\"lat\":" + floatToString(flat,TinyGPS::GPS_INVALID_F_ANGLE, 10, 6) + ",\"lng\":" + floatToString(flon,TinyGPS::GPS_INVALID_F_ANGLE, 11, 6) + ",\"api_key\":\"862104518000188\"}";

  if(gpsData.indexOf("v") > 0){
    gpsData = "{\"lat\":7.207573,\"lng\":125.395874,\"api_key\":\"862104518000188\"}";    
  }
